...
/// Default vector of board and vector of decision should have 10 positions, because of more readable indexes, so the first position will be -5;
 void game(){
    vector<int> board;
    ...
    if(!whosTurnToMove)
    {
         vector<int> decisionsVector = getDecisionVector();
         int theBestMove = -1;
